...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx/Vitis/2020.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx/Vitis/2020.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx/Vitis/2020.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx/Vitis/2020.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx/Vitis/2020.1/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "region.autotvin.dat"
	set constFileTvOut       "region.autotvout.dat"
	set constFileHdlTvIn     "region.autohdltvin.dat"
	set constFileHdlTvOut    "region.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
