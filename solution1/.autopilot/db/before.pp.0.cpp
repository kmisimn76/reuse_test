...
# 2 "<built-in>" 2
# 1 "reuse_test/before.cpp" 2

void load_a(volatile int* A, int* a_buf, int ona, int on, int tilenuma, int tilen, int n) {
 VITIS_LOOP_3_1: for(int i=0;i<tilenuma;i++) {
  VITIS_LOOP_4_2: for(int j=0;j<tilen;j++) {
...
void load_b(volatile int* B, int* b_buf, int ona, int tilenuma, int onc, int tilenumc, int numa, int numc) {
 VITIS_LOOP_14_1: for(int i=0;i<tilenuma;i++) {
  VITIS_LOOP_15_2: for(int j=0;j<tilenumc;j++) {
#pragma hls latency min=484 max=484
...
void store_c(volatile int* C, int* c_buf, int onc, int on, int tilenumc, int tilen, int n) {
 VITIS_LOOP_25_1: for(int i=0;i<tilenumc;i++) {
  VITIS_LOOP_26_2: for(int j=0;j<tilen;j++) {
...
void conv(int* a_buf, int* b_buf, int* c_buf, int tilen, int tilenuma, int tilenumc) {
 int local_c[100] = {0};
 VITIS_LOOP_38_1: for(int c=0;c<tilenuma;c++) {
  VITIS_LOOP_39_2: for(int a=0;a<tilenuma;a++) {
   VITIS_LOOP_40_3: for(int n=0;n<tilen;n++) {
...
__attribute__((sdx_kernel("region_before", 0))) void region_before(volatile int* A, volatile int* B, volatile int* C,
  int numa, int numc, int n,
  int tilenuma, int tilenumc, int tilen,
  int numa_iter, int numc_iter, int n_iter) {
#pragma HLS TOP name=region_before
# 56 "reuse_test/before.cpp"
 ...
 int b_buf[100];
 int c_buf[100];
 VITIS_LOOP_63_1: for(int ona=0;ona<numa_iter;ona++) {
  VITIS_LOOP_64_2: for(int on=0;on<n_iter;on++) {
   VITIS_LOOP_65_3: for(int onc=0;onc<numc_iter;onc++) {
