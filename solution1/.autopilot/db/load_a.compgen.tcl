...
set id 18
set name region_mul_32ns_32ns_64_1_1
...
set id 20
set name region_mul_64ns_32ns_96_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set id 21
set name region_mac_muladd_7s_7s_7ns_7_4_1
...
set ID 25
set hasByteEnable 0
set MemName region_load_a_a_buf_data_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_a_buf_s \
    op interface \
    ports { a_buf_s_din { O 3200 vector } a_buf_s_full_n { I 1 bit } a_buf_s_write { O 1 bit } } \
} "
}
