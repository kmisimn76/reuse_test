...
set id 9
set name region_before_mul_32ns_32ns_64_1_1
...
set id 10
set name region_before_mac_muladd_7s_7s_7ns_7_4_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename a_buf \
    op interface \
    ports { a_buf_address0 { O 7 vector } a_buf_ce0 { O 1 bit } a_buf_we0 { O 1 bit } a_buf_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tilen \
    op interface \
    ports { tilen_dout { I 32 vector } tilen_empty_n { I 1 bit } tilen_read { O 1 bit } } \
} "
}
