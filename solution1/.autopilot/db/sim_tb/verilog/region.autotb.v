...
`define AUTOTB_TVIN_A  "./c.region.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.region.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.region.autotvin_C.dat"
`define AUTOTB_TVIN_tilenuma  "./c.region.autotvin_tilenuma.dat"
`define AUTOTB_TVIN_tilenumc  "./c.region.autotvin_tilenumc.dat"
`define AUTOTB_TVIN_tilen  "./c.region.autotvin_tilen.dat"
`define AUTOTB_TVIN_numa_iter  "./c.region.autotvin_numa_iter.dat"
`define AUTOTB_TVIN_numc_iter  "./c.region.autotvin_numc_iter.dat"
`define AUTOTB_TVIN_n_iter  "./c.region.autotvin_n_iter.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.region.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.region.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.region.autotvin_C.dat"
`define AUTOTB_TVIN_tilenuma_out_wrapc  "./rtl.region.autotvin_tilenuma.dat"
`define AUTOTB_TVIN_tilenumc_out_wrapc  "./rtl.region.autotvin_tilenumc.dat"
`define AUTOTB_TVIN_tilen_out_wrapc  "./rtl.region.autotvin_tilen.dat"
`define AUTOTB_TVIN_numa_iter_out_wrapc  "./rtl.region.autotvin_numa_iter.dat"
`define AUTOTB_TVIN_numc_iter_out_wrapc  "./rtl.region.autotvin_numc_iter.dat"
`define AUTOTB_TVIN_n_iter_out_wrapc  "./rtl.region.autotvin_n_iter.dat"
`define AUTOTB_TVOUT_C  "./c.region.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.region.autotvout_C.dat"
module `AUTOTB_TOP;
...
reg all_finish; 
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.region.autotvout_C.dat", "r");
    fp2 = $fopen("./impl_rtl.region.autotvout_C.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.region.autotvout_C.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.region.autotvout_C.dat\"!");
    else begin
        $display("Comparing rtl.region.autotvout_C.dat with impl_rtl.region.autotvout_C.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
