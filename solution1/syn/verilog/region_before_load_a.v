...
reg   [31:0] i_reg_122;
reg   [31:0] j_reg_133;
reg   [31:0] tilen_read_reg_225;
reg    ap_block_state1;
wire  signed [6:0] empty_fu_144_p1;
reg  signed [6:0] empty_reg_230;
wire   [63:0] bound_fu_156_p2;
reg   [63:0] bound_reg_235;
wire   [0:0] icmp_ln3_fu_162_p2;
reg   [0:0] icmp_ln3_reg_240;
...
reg   [0:0] icmp_ln3_reg_240_pp0_iter1_reg;
reg   [0:0] icmp_ln3_reg_240_pp0_iter2_reg;
wire   [63:0] add_ln3_fu_167_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [31:0] select_ln3_1_fu_192_p3;
reg   [31:0] select_ln3_1_reg_249;
wire   [6:0] empty_20_fu_204_p1;
reg   [6:0] empty_20_reg_259;
reg   [6:0] empty_20_reg_259_pp0_iter1_reg;
wire   [31:0] add_ln4_fu_208_p2;
...
reg   [31:0] ap_phi_mux_i_phi_fu_126_p4;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln8_fu_214_p1;
wire   [31:0] bound_fu_156_p0;
wire   [31:0] bound_fu_156_p1;
wire   [0:0] icmp_ln4_fu_173_p2;
wire   [31:0] add_ln3_1_fu_186_p2;
wire   [31:0] select_ln3_fu_178_p3;
wire  signed [6:0] grp_fu_218_p3;
wire  signed [6:0] grp_fu_218_p0;
...
region_before_mac_muladd_7s_7s_7ns_7_4_1 #(
    ...
    .din2_WIDTH( 7 ),
    .dout_WIDTH( 7 ))
mac_muladd_7s_7s_7ns_7_4_1_U10(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_218_p0),
    .din1(empty_reg_230),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state2))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (tilen_out_full_n == 1'b0) | (tilenuma_out_full_n == 1'b0) | (tilen_empty_n == 1'b0) | (tilenuma_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln3_reg_240 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln3_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (tilen_out_full_n == 1'b0) | (tilenuma_out_full_n == 1'b0) | (tilen_empty_n == 1'b0) | (tilenuma_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln3_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln3_reg_240_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        a_buf_we0 = 1'b1;
    end else begin
        a_buf_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((icmp_ln3_fu_162_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln3_reg_240 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln3_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter484 == 1'b1) & (ap_enable_reg_pp0_iter483 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln3_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter484 == 1'b1) & (ap_enable_reg_pp0_iter483 == 1'b0)))) begin
...
assign a_buf_address0 = zext_ln8_fu_214_p1;

assign a_buf_d0 = A;

assign add_ln3_1_fu_186_p2 = (32'd1 + ap_phi_mux_i_phi_fu_126_p4);

assign add_ln3_fu_167_p2 = (indvar_flatten_reg_111 + 64'd1);

assign add_ln4_fu_208_p2 = (32'd1 + select_ln3_fu_178_p3);
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (tilen_out_full_n == 1'b0) | (tilenuma_out_full_n == 1'b0) | (tilen_empty_n == 1'b0) | (tilenuma_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign bound_fu_156_p00 = tilen_dout;

assign bound_fu_156_p1 = bound_fu_156_p10;

assign bound_fu_156_p10 = tilenuma_dout;

assign empty_20_fu_204_p1 = select_ln3_fu_178_p3[6:0];

assign empty_fu_144_p1 = tilen_dout[6:0];

assign grp_fu_218_p0 = select_ln3_1_fu_192_p3[6:0];

assign icmp_ln3_fu_162_p2 = ((indvar_flatten_reg_111 == bound_reg_235) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_173_p2 = ((j_reg_133 == tilen_read_reg_225) ? 1'b1 : 1'b0);

assign select_ln3_1_fu_192_p3 = ((icmp_ln4_fu_173_p2[0:0] === 1'b1) ? add_ln3_1_fu_186_p2 : ap_phi_mux_i_phi_fu_126_p4);

assign select_ln3_fu_178_p3 = ((icmp_ln4_fu_173_p2[0:0] === 1'b1) ? 32'd0 : j_reg_133);

assign tilen_out_din = tilen_dout;

assign tilenuma_out_din = tilenuma_dout;

assign zext_ln8_fu_214_p1 = $unsigned(grp_fu_218_p3);

endmodule //region_before_load_a
