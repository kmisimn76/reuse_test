...
entity region_before_dataflow_parent_loop_proc7 is
port (
...
architecture behav of region_before_dataflow_parent_loop_proc7 is 
...
attribute shreg_extract : string;
    signal dataflow_parent_loop_proc_U0_C_o : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_C_o_ap_vld : STD_LOGIC;
    ...
    signal dataflow_parent_loop_proc_U0_numc_iter_ap_vld : STD_LOGIC;
    ...
    component region_before_dataflow_parent_loop_proc IS
    port (
        numc_iter : IN STD_LOGIC_VECTOR (31 downto 0);
        A : IN STD_LOGIC_VECTOR (31 downto 0);
        B : IN STD_LOGIC_VECTOR (31 downto 0);
...
begin
    dataflow_parent_loop_proc_U0 : component region_before_dataflow_parent_loop_proc
    port map (
        numc_iter => numc_iter,
        A => A,
        B => B,
    ...
    bound_minus_1 <= std_logic_vector(unsigned(n_iter) - unsigned(ap_const_lv32_1));
    ...
    dataflow_parent_loop_proc_U0_numc_iter_ap_vld <= numc_iter_ap_vld;
